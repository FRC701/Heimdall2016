...
#include "Commands/defaultElevator.h"
#include "Commands/defaultIntake.h"
#include "Commands/defaultLights.h"
#include "Commands/ElevatorUp.h"
#include "Commands/ElevatorDown.h"
#include "Commands/HaySqueezeOpenClose.h"
...
OI::OI() {
    ...
    coButtonRB->WhileHeld(new ElevatorUp());
    coButtonLB.reset(new JoystickButton(coDriver.get(), 5));
    coButtonLB->WhileHeld(new ElevatorDown());
    ...
    coButtonX->WhileHeld(new IntakeIn());
    ...
    coButtonA->WhileHeld(new HaySqueezeOpenClose());
    ...
    SmartDashboard::PutData("defaultLights", new defaultLights());
